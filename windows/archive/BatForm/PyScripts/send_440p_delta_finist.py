# Шамшурин И.А 29.11.24
# Отправка 440П через Дельту + финист
import os, shutil, re, subprocess, time
from datetime import date, datetime
dir_in="Z:\\440\\IN\\export" # директория с входящими xml
#dir_in="H:\\no_440\\test\\OUT1"
...
if dir_in_files:
    ...
    for item in subscribers:
        try:
            print(item)
            subprocess.run(["C:\FormSender\Send2Jabber.exe","ptkpsd@jabber.tcbdomen.trustcombank.ru","ptkpsd","10.129.135.253","5222",item+"@jabber.tcbdomen.trustcombank.ru","Файлы по 440-п отправлены (Дельта,Finist)"])
        except:
            pass    
        time.sleep(2)                                                                                                                                                         
